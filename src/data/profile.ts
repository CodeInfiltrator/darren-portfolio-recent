export const profile = {
  name: "Frizzia Darren",
  shortName: "Frizzia",
  role: "Software Engineer • iOS Developer • Product Builder",
  location: "Jakarta, Indonesia",
  email: "efdarrens@gmail.com",
  handle: "@frizzia_darren",

  image: "public/images/profile.jpg",

  tagline:
    "I build human-centered digital products with a focus on iOS development, software engineering, and product thinking.",

  status: "Building across software, product, and personal branding",
  ...
  stats: [
    { value: "3.80", label: "GPA" },
    { value: "Cohort 9", label: "Apple Developer Academy" },
  ...
  },
  {
    ...
    impact:
      "Explored user flow, scheduling behavior, SwiftUI interface structure, and Apple Human Interface Guidelines.",
    tags: ["SwiftUI", "HIG", "Product Design", "iOS"],
    image: "/images/projects/sisabaik.png"
  }
],
  ...
  experience: [
    ...
    },
    {
      ...
      subtitle: "Front-End, Back-End, UI/UX, and Web Development",
      description:
        "Learned the fundamentals of front-end development, back-end development, UI/UX design, and collaborative project building through structured learning activities and hands-on practice."
    },
    {
      period: "2023 — Now",
  ...
  modeling: {
    headline: "Modeling is where discipline becomes presence.",
    description:
      "Besides software development, I build my identity through modeling: runway, fashion, body control, camera confidence, and storytelling through visual presence.",
    details: [
      "Height: 186 cm",
      "Based in Jakarta",
      "Open for runway, photoshoot, and brand collaboration"
    ]
  }
};